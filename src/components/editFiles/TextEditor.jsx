  ...
  function onCreate() {
    ...
    setInterval(() => {
      if (contentChanged) {
        ...
        editorRef.current?.documentEditor.saveAsBlob("Docx").then((blob) => {
          ...
          const storageRef = ref(
            storage,
            `files/${profileData.org}/${fileName}`
          );
          const uploadTask = uploadBytesResumable(storageRef, exportedDocument);
